...
const upload = multer({
  ...
  limits: {
    ...
    files: 50 // Increased to handle all antenna structure categories
  },
...
const imageCategories = [
  ...
  'lightening_rods',
  'empty_mount_side_arm_1_photo',
  'empty_mount_side_arm_2_photo',
  'empty_mount_side_arm_3_photo',
  'empty_mount_side_arm_4_photo',
  'empty_mount_side_arm_5_photo',
  'empty_mount_side_arm_6_photo',
  'empty_mount_side_arm_7_photo',
  'empty_mount_side_arm_8_photo',
  'empty_mount_side_arm_9_photo',
  'empty_mount_side_arm_10_photo',
